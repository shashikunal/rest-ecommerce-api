...
export function buildDefaultPolicies(): RateLimitPolicy[] {
  return [
    ...
    },
    {
      ...
      limit: 60,
      windowMs: 60000,
      keyPrefix: 'rl:wishlist',
      match: { pathPrefix: '/api/v1/wishlist' },
    },
    {
      ...
      limit: 60,
      windowMs: 60000,
      keyPrefix: 'rl:inventory_read',
      match: { method: 'GET', pathPrefix: '/api/v1/inventory' },
    },
    {
      ...
      limit: 30,
      windowMs: 60000,
      keyPrefix: 'rl:inventory_write',
      match: { pathPrefix: '/api/v1/inventory' },
    },
    {
      scope: 'MEDIA_UPLOAD',
      identifier: 'user',
